  ...
  return (
    ...
    <>
      <div className="p-4 debug-screens">
        <h1 className="mb-4 text-2xl font-bold text-foreground dark:text-muted-foreground">
          Advanced Tailwind Features
        </h1>

        <div className="space-y-8">
          <div>
            <h2 className="mb-2 text-lg font-semibold text-foreground dark:text-muted-foreground">
              Custom Spacing
            </h2>
          ...
          <div>
            ...
            <form className="space-y-4">
              <div>
                <label
                  className="mb-1 block text-foreground dark:text-muted-foreground"
                  htmlFor="name"
                >
                  Name
                </label>
              ...
              <div>
                ...
                />
                <label
                  className="ml-2 text-foreground dark:text-muted-foreground"
                  htmlFor="terms"
                >
              ...
              <button
                className="rounded bg-[hsl(var(--primary))] px-4 py-2 font-bold text-white transition-all duration-200 ease-in-out hover:bg-[hsl(var(--primary-foreground))] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                type="submit"
              >
                Submit
              </button>
