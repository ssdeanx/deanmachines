 ...
 */
export const llmChainTool = createTool({
  id: "llm-chain",
  ...
  outputSchema: z.object({
    result: z.string().describe("The LLM response text"),
 ...
 */
export const aiSdkPromptTool = createTool({
  id: "ai-sdk-prompt",
  ...
  outputSchema: z.object({
    text: z.string().describe("The LLM response text"),
    structured: z
      .any()
      .optional()
      .describe("Structured output if schema was provided"),
    success: z.boolean().describe("Whether the operation was successful"),
    metadata: z
      .object({
        provider: z.string(),
  ...
  execute: async ({ context, threadId: executionThreadId, resourceId }) => {
    const startTime = Date.now(); // Create run for LangSmith tracing
